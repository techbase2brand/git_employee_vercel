...
const AddModule: React.FC<any> = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get<Task[]>("https://empmgt.base2brand.com/get/addTaskEvening",{
        headers: {
  ...
  useEffect(() => {
    const token = localStorage.getItem("myToken");
    // Fetch employees from the backend API
    axios.get<Module[]>("https://empmgt.base2brand.com/get/modules", {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    })
  ...
  const handleSubmit = () => {
    if (evngEditID) {
      axios
        .put(
          `https://empmgt.base2brand.com/update/addEvngTask/${evngEditID}`,
          eveningTask,
          {
            headers: {
              Authorization: `Bearer ${localStorage.getItem("myToken")}`,
      ...
      axios
        .post("https://empmgt.base2brand.com/create/addTaskEvening", eveningTask,{
          headers: {
            Authorization: `Bearer ${localStorage.getItem("myToken")}`,
          },
        })

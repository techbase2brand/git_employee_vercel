...
useEffect(() => {
  ...
  axios
    .get<LeaveData[]>("http://empbackend.base2brand.com/get/leaveinfo", {
      headers: {
...
const handleApprove = (LeaveInfoID: number) => {
  ...
  axios
    .put(`http://empbackend.base2brand.com/approveLeaveHR/${LeaveInfoID}`, {}, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    })
  ...
  const handleDeny = (LeaveInfoID: number) => {
    axios
      .put(`http://empbackend.base2brand.com/denyLeaveHR/${LeaveInfoID}`)
      .then((response) => {
        console.log(response.data);
